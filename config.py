...
OWNER_NAME = getenv("OWNER_NAME", "xORDENDİ")
ALIVE_NAME = getenv("ALIVE_NAME", "xORDENDİ")
...
IMG_1 = getenv("IMG_1", "https://www.hizliresim.com/dti93fa.png")
IMG_2 = getenv("IMG_2", "https://www.hizliresim.com/dti93fa.png")
IMG_3 = getenv("IMG_3", "https://www.hizliresim.com/dti93fa.png")
IMG_4 = getenv("IMG_4", "https://www.hizliresim.com/dti93fa.png")
